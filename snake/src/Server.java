...
public class Server 
{
    ...
    */
    ...
    private Hashtable<Integer, ConnectionService> players = 
        new Hashtable<Integer, ConnectionService>();
            ...
            {    
                while (true) 
                {
                    ...
                    else if (receivedMessage.contains("create"))
                    {
                        if (gameState) 
                        {
                            outputWriter.println("\"connection\": \"rejected\"");
                    ...
                    else if (receivedMessage.contains("waiting"))
                    {
                        int i;
                        for (i = 0; i < 55; i++)
                        {
                            String jsonString = String.format("{\"snake\":{\"snake1\":[{\"x\":%d,\"y\":30},{\"x\":%d,\"y\":30},{\"x\":%d,\"y\":30},{\"x\":%d,\"y\":30},{\"x\":%d,\"y\":30}]}}", i-6, i-5, i-4, i-3, i-2, i-1, i);
